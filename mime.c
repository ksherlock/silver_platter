...
const char *GetMimeString(const GSString255Ptr filename, Word fileType,
                          LongWord auxType) {
  const char *mime;
  ...
  case 0xe0:
    ...
    else if (auxType == 0x0002)
      mime = "multipart/appledouble";
    else if (auxType == 0x8000)
      mime = "application/x-BinaryII";
    else if (auxType == 0x8002)
      mime = "application/x-Shrinkit";
  }
  return mime;
}
