...
static struct sfdlg dlg640 = {{0, 0, Height640, Width640},
                              -1,
                              0,
                              {&Save640, &Open640, &Close640, &Disks640,
                               &Cancel640, &Scroll640, &Paths640, &Files640,
                               &Prompt640, &Edit640, &Free640, &Folder640,
                               //&Folder640,
                               NULL}};

static struct sfdlg dlg320 = {{0, 0, Height320, Width320},
                              -1,
                              0,
                              {&Save320, &Open320, &Close320, &Disks320,
                               &Cancel320, &Scroll320, &Paths320, &Files320,
                               &Prompt320, &Edit320, &Free320, &Folder320,
                               //&Folder320,
                               NULL}};
...
static LongWord controls640[] = {
    (LongWord)&ctrl_le640, (LongWord)&ctrl_create640, (LongWord)&ctrl_cancel640,
    (LongWord)&ctrl_stat640, 0};
...
static LongWord controls320[] = {
    (LongWord)&ctrl_le320, (LongWord)&ctrl_create320, (LongWord)&ctrl_cancel320,
    (LongWord)&ctrl_stat320, 0};
...
static Word GetFolder(void) {
  ...
  oldPort = GetPort();
  w = NewWindow2(NULL, NULL, NULL, NULL, refIsPointer,
                 GetMasterSCB() & 0x80 ? (Long)&windowTemp640
                                       : (Long)&windowTemp320,
                 0x800e);
...
pascal void SFGetFolder2(Word x, Word y, Word prDesc, Ref prRef,
  ...
  fSuccess = 0;
  SFPPutFile2(x, y, NULL, prDesc, prRef, refIsPointer, (Ref) "\x05\x00hello",
